'''
Футбольные матчи, из последних задач курса: Программирование на Python.
Вводим количество игр, которые надо подсчитать.
Вводим данные команд и счет, пример: Динамо;4;Спартак;5
Выводим отчет: Сколько игр сыграла команда, победы, ничьи, поражения и очки
'''
